...
let OrderApi = {
    ...
    orderlist(data, errorback) {
        return request._post('order.order/lists', data, errorback);
    },
    /*订单详情*/
    orderdetail(data, errorback) {
        return request._post('order.order/detail', data, errorback);
    },
    /*售后管理*/
    ...
    delivery(data, errorback) {
        return request._post('order.order/delivery', data, errorback);
    },
    /*确认审核*/
    ...
    updatePrice(data, errorback) {
        return request._post('order.order/updatePrice', data, errorback);
    },
}
