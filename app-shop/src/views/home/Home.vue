<template>
  <div class="home" v-loading="loading">
    ...
    <div class="matters-wrap">
      <div class="common-form mt16">待办事项</div>
          ...
          <div class="matters">
            <div class="box">
              ...
              <ul>
                <li>
                  待处理案件：
                  <span class="fb">{{right_away.mediate}}</span>
                </li>
                <li>
                  待处理援助：
                  <span class="fb">{{right_away.help}}</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="matters">
            <div class="box">
              ...
              <ul>
                <li>
                  未读消息：
                  <span class="fb">{{right_away.notice}}</span>
                </li>
              </ul>
            </div>
          </div>
    ...
    <div class="home-index">
      ...
      <div class="main-index">
        <div class="common-form mt16">今日概况</div>
