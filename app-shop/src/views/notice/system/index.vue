      ...
      <div class="table-wrap">
        <el-table size="small" :data="tableData.data" style="width: 100%">
          ...
          <el-table-column fixed="right" width="100px">
            <template slot-scope="scope">
              <el-button @click="addClick(scope.row)" size="mini" v-auth="'/notice/system/detail'">
                查看
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      let curPage = sessionStorage.getItem('notice_system_curPage');
      if (curPage) {
    ...
    methods: {
      ...
      handleCurrentChange(val) {
        ...
        self.curPage = val;
        self.loading = true;
        sessionStorage.setItem('notice_system_curPage', val);
        self.getData();
      },
      ...
      handleSizeChange(val) {
        this.curPage = 1;
        this.pageSize = val;
        sessionStorage.setItem('notice_system_curPage', 1);
        this.getData();
      },
