      ...
      <div class="table-wrap">
        <el-table size="small" :data="tableData.data" style="width: 100%">
          ...
          <el-table-column fixed="right" width="100px">
            <template slot-scope="scope">
              <el-button @click="addClick(scope.row)" size="mini" v-auth="'/notice/help/detail'">
                回复
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      let curPage = sessionStorage.getItem('notice_help_curPage');
      if (curPage) {
    ...
    methods: {
      ...
      handleCurrentChange(val) {
        ...
        self.loading = true;
        self.curPage = val;
        sessionStorage.setItem('notice_help_curPage', val);
        self.getData();
      },
      ...
      handleSizeChange(val) {
        this.curPage = 1;
        this.pageSize = val;
        sessionStorage.setItem('notice_help_curPage', 1);
        this.getData();
      },
