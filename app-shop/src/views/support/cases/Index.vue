        ...
        <el-table :data="tableData" size="small" style="width: 100%" v-loading="loading">
          ...
          <el-table-column fixed="right" align="right" width="150px">
            <template slot-scope="scope">
              <el-button @click="editClick(scope.row)" size="mini" v-auth="'/support/cases/edit'">编辑</el-button>
              <el-button @click="deleteClick(scope.row)" size="mini" type="danger" v-auth="'/support/cases/delete'">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
