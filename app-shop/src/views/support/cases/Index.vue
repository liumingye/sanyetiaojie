  ...
  <div class="cases">
    ...
    <div class="common-seach-wrap">
      <el-form size="small" :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item><el-button size="small" type="primary" icon="el-icon-plus" @click="addClick" v-auth="'/support/cases/add'">添加案例</el-button></el-form-item>
      </el-form>
    </div>
    <!--内容-->
    <div class="content">
        ...
        <el-table :data="tableData" size="small" border style="width: 100%" v-loading="loading">
          ...
          <el-table-column fixed="right" label="操作" width="100">
            <template slot-scope="scope">
              <el-button @click="editClick(scope.row)" type="text" size="small" v-auth="'/support/cases/edit'">编辑</el-button>
              <el-button @click="deleteClick(scope.row)" type="text" size="small" v-auth="'/support/cases/delete'">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
...
export default {
  ...
  methods: {
    ...
    getData(){
      ...
      CasesApi.supportLists(Params, true)
        .then(data => {
          self.loading = false;
    ...
    /*打开添加*/
    addClick(item) {
      this.$router.push('/support/cases/add');
    },

    /*打开编辑*/
    editClick(item) {
      this.$router.push({
        path: '/support/cases/edit',
        query: {
            id: item.id
        }
      });
