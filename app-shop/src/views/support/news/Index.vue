  ...
  <div class="news">
    ...
    <div class="common-seach-wrap">
      <el-form size="small" :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item><el-button size="small" type="primary" icon="el-icon-plus" @click="addClick" v-auth="'/support/news/add'">添加新闻</el-button></el-form-item>
      </el-form>
    </div>
    <!--内容-->
    <div class="content">
...
export default {
  ...
  methods: {
    ...
    getData(){
      ...
      NewsApi.supportLists(Params, true)
        .then(data => {
          self.loading = false;
    ...
    /*打开添加*/
    addClick(item) {
      this.$router.push('/support/news/add');
    },

    /*打开编辑*/
    editClick(item) {
      this.$router.push({
        path: '/support/news/edit',
        query: {
            id: item.id
        }
      });
