        ...
        <el-table size="mini" :data="tableData" row-key="cid" default-expand-all :tree-props="{ children: 'child' }" style="width: 100%"  v-loading="loading">
          ...
          <el-table-column fixed="right" align="right" width="150px">
            <template slot-scope="scope">
              <el-button @click="editClick(scope.row)" size="mini" v-auth="'/support/lawcat/edit'">编辑</el-button>
              <el-button @click="deleteClick(scope.row)" size="mini" type="danger" v-auth="'/support/lawcat/delete'">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
