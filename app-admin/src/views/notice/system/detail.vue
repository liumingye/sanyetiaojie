        ...
        <div id="dataShow" :class="[browser==='Chrome'? 'dataShowCM': 'dataShowFF']">
          ...
          <div v-for="(item,index) in radioInfoList.data" :key="index" style="background-color: #f5f5f5; padding:0 24px 16px;">
            <el-row v-if="item.is_user==0">
              ...
              <span class="aa" @mouseup="selectAll">{{ item.text }}</span>
            </el-row>
            <el-row v-if="item.is_user==1">
              ...
              <el-row class="bb">
                ...
                <el-col class="text">
                  <span @mouseup="selectAll">{{ item.text }}</span>
                </el-col>
              </el-row>
            </el-row>
          </div>
...
export default {
  ...
  methods: {
    ...
    selectAll(e) {
      if (e.button === 2 && window.getSelection().toString() == '') {
      ...
      NoticeApi.noticeDetail(
        ...
        .then((data) => {
          ...
          if (self.page == 1) {
            ...
            self.radioInfoList.data = data.data.data.data.concat(
              self.radioInfoList.data
            );
          }
          self.loading = false;
          cb && cb();
