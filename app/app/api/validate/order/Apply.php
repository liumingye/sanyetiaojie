...
class Apply extends Validate
{
    protected $rule =   [
        ...
        'my_area'  => 'require|max:255',
        'my_address'  => 'require|max:255',
    ...
    protected $message  =   [
        ...
        'my_area.require' => '请填写申请人地区',
        'my_area.max' => '申请人地区最多不能超过255个字符',
        'my_address.require' => '请填写申请人住址',
        'my_address.max' => '申请人住址最多不能超过255个字符',
        ...
        'other_phone.mobile' => '纠纷当事人手机号格式错误',
        'other_area.max' => '纠纷当事人地区最多不能超过255个字符',
        'other_address.max' => '纠纷当事人住址最多不能超过255个字符',
